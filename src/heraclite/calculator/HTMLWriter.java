...
public class HTMLWriter {
  ...
  private String generateTableHeader() {
    return "<tr><th" + addTdCss() + ">Periode</th><th" + addTdCss() + ">Capital debut</th><th" + addTdCss() + ">Versement total</th><th" + addTdCss() + ">Versement interet</th>" + "<th" + addTdCss()
        + ">Versement capital</th><th" + addTdCss() + ">Capital fin</th><th" + addTdCss() + ">Versement total cumulatif</th>" + "<th" + addTdCss() + ">Versement interet cumulatif</th><th"
        + addTdCss() + ">Versement capital cumulatif</th></tr>" + getLineSeparator();
  }
